                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$do->pakar}}</td>
                            <td>
                            <a href="/dosen/edit/{{ $do->id }}" class="btn btn-outline-danger">EDIT</i>
                            <i class="material-icons" style="font-size:15px;">restore_page</i>
                            <a href="/dosen/hapus/{{ $do->id }}" class="btn btn-outline-warning" 
                                onclick="return confirm('Apa Anda Yakin ingin menghapus?') ">HAPUS</i>
